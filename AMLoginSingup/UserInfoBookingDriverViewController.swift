//
//  UserInfoBookingDriverViewController.swift
//  AMLoginSingup
//
//  Created by Abdulaziz  Almohsen on 3/8/17.
...
class UserInfoBookingDriverViewController  : UIViewController , UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        niehgborhood.selectedItem == UserDataSingleton.sharedDataContainer.user_nigborhood
    ...
    @IBAction func COnfirmTapped(_ sender: Any) {
        ...
        UserDataSingleton.sharedDataContainer.user_nigborhood = niehgborhood.selectedItem
        
        UserDataSingleton.sharedDataContainer.user_street = street.text
        UserDataSingleton.sharedDataContainer.user_phone = phone.text
    ...
    func clickOnRegister () {
        ...
        alert.addButton("تسجيل", backgroundColor: UIColor.brown, textColor: UIColor.yellow, showDurationStatus: true) {
            ...
            print("تم التسجيل")
            if textfield2.text == "" , textfield3.text == "" , textfield4.text == "" {
                
                print("hi")
                self.panel.showNotify(withStatus: .failed, inView: self.view, title: "اكمل المعلومات")
