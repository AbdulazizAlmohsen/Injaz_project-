...
//  AMLoginSingup
//
//  Created by Abdulaziz  Almohsen on 12/19/16.
...
class ResultViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        guard let pic =  MaidDataContainerSingleton.sharedDataContainer.pic else { return  }
    ...
    @IBAction func reservationtapped(_ sender: UIButton) {
        ...
        let urlstr = "http://localhost:8000/api/hour"
...
//            "name": "\(UserDataSingleton.sharedDataContainer.username!)",
            ...
            "national_id": "\(UserDataSingleton.sharedDataContainer.user_national_id!)",
             "status" : "تم الطلب",
             "id" : "\(MaidDataContainerSingleton.sharedDataContainer.id!)",
